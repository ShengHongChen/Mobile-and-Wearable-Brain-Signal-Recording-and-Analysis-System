                    ...
                    if (datapoint > 504) {
                        ...
                        if (nftpoint / 250 >= 1) {
                            ...
                            if (checkdata == false) {
                                ...
                                alphaCh1 = (drawNftCH1[7] + drawNftCH1[8] + drawNftCH1[9] + drawNftCH1[10] + drawNftCH1[11]).toFloat()
                                alphaCh2 = (drawNftCH2[7] + drawNftCH2[8] + drawNftCH2[9] + drawNftCH2[10] + drawNftCH2[11]).toFloat()
                                if (writeAmplitude == true) {
                                    totalAlpha = alphaCh1 + alphaCh2
                                    Log.d("FFT", totalAlpha.toString())
                                }
                            }
